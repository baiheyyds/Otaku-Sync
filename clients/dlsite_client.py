...
from utils import logger  # 引入新的日志工具
...
class DlsiteClient:
    ...
    def __init__(self, headers=None):
        self.headers = headers or {
            ...
            "Cookie": "adultchecked=1;",  # 添加年龄验证Cookie，提高稳定性
        }
    ...
    def search(self, keyword, limit=30):
        ...
        try:
            ...
            filtered_results = [
                item for item in results if not any(ex_kw in (item.get("类型") or "") for ex_kw in exclude_keywords)
            ]
